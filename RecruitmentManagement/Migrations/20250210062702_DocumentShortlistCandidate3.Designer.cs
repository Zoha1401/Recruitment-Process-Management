...
namespace RecruitmentManagement.Migrations
{
    ...
    [Migration("20250210062702_DocumentShortlistCandidate3")]
    partial class DocumentShortlistCandidate3
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RecruitmentManagement.Model.DocumentStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("RecruitmentManagement.Model.DocumentStatus", b =>
                {
                    b.HasOne("RecruitmentManagement.Model.Document", "Document")
                        .WithOne("DocumentStatus")
                        .HasForeignKey("RecruitmentManagement.Model.DocumentStatus", "DocumentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RecruitmentManagement.Model.DocumentStatusType", "Status")
