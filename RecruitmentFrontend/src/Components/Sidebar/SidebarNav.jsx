...
const SidebarNav = ({candidate, shortlisted}) => {
   ...
   <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
      ...
      {role=="Recruiter" && (
        ...
        <div className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
           ...
           <Link to={`/createJob`} className='flex-1 ms-3 whitespace-nowrap'><button>Create Job</button></Link>
        </div>
     </li>
     <li>
        <div className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
           ...
           <Link to={`/recruiterDashboard`} className='flex-1 ms-3 whitespace-nowrap'><button>Job Openings</button></Link>
        </div>
     </li>
     <li>
        <div className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
        <svg className="shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 18">
           ...
           <span className="flex-1 ms-3 whitespace-nowrap"> <Link to={`/viewCandidates`} className=''><button>View Candidates</button></Link></span>
     ...
     <li>
        ...
        <svg className="shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 18">
           ...
           <span className="flex-1 ms-3 whitespace-nowrap"> <Link to={`/viewInterviews`} className=''><button>View Interviews</button></Link></span>
        </div>
     </li>
   </>
      )
    ...
    <div className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
       ...
       <span className="flex-1 ms-3 whitespace-nowrap"><Link to={`/viewApplications/${candidate.CandidateId}`}>View Applications</Link></span>
    </div>
 </li>
 <li>
    <div className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
       ...
       <span className="flex-1 ms-3 whitespace-nowrap"><button disabled={!shortlisted}><Link to={`/uploadDocuments/${candidate.CandidateId}`}>Upload Documents</Link></button></span>
    </div>
 </li>
 <li>
    <div className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
       ...
       <span className="flex-1 ms-3 whitespace-nowrap"><button><Link to={`/candidateDashboard`}>Job Openings</Link></button></span>
    </div>
 </li></>
  )}
  {role=="Reviewer" && (
    ...
    <div className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
       ...
       <span className="flex-1 ms-3 whitespace-nowrap"><button><Link to={`/reviewerDashboard`}>View Assigned Jobs</Link></button></span>
    </div>
 </li></>
  )}
         ...
         <li>
            ...
            <svg className="shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 16">
               ...
               <span className="flex-1 ms-3 whitespace-nowrap"><button color='error'  className="btn btn-danger btn-sm" onClick={handleLogout}>
        Logout
      </button></span>
            </div>
         </li>
         <li>
            <div className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
               ...
               <span className="flex-1 ms-3 whitespace-nowrap"><Link to="/">Register User</Link></span>
            </div>
         </li>
